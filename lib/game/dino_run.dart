...
class DinoRun extends FlameGame with TapDetector, HasCollisionDetection {
  ...
  Future<void> onLoad() async {
    ...
    final parallaxBackground = await loadParallaxComponent(
      [
        ParallaxImageData('parallax1/plx-1.png'),
        ParallaxImageData('parallax1/plx-2.png'),
        ParallaxImageData('parallax1/plx-3.png'),
        ParallaxImageData('parallax1/plx-4.png'),
        ParallaxImageData('parallax1/plx-5.png'),
        ParallaxImageData('parallax1/plx-6.png'),
      ],
